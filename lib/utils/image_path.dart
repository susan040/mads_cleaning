class ImagePath {
  ...
  static const String blankPhoto = "$baseImagePath/blank_photo.jpg";
  static const String advertisment = "$baseImagePath/advertisment.png";
  static const String windowCleaning = "$baseImagePath/window.png";
  static const String carpetCleaning = "$baseImagePath/carpet.png";
  static const String officeCleaning = "$baseImagePath/office.png";
  static const String gardenCleaning = "$baseImagePath/garden.png";
