...
Widget buildHouseCleaningWidget(
    ...
    required int numberOfBedroom,
    required int numberOfBathroom,
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Text("${numberOfBedroom}", style: CustomTextStyles.f14W400()),
                ],
              ),
              const SizedBox(height: 16),
              Row(
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text("Frequency:", style: CustomTextStyles.f14W700()),
                  Text("${frequency}", style: CustomTextStyles.f14W400()),
                ],
              ),
              const SizedBox(height: 16),
              Row(
...
Widget buildBuilderCleaningWidget(
    {required String serviceName,
    required String serviceStatus,
    required String serviceDate,
    required String serviceTime,
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text("Site Visit Date:", style: CustomTextStyles.f14W700()),
                  Text("${siteVisitDate}", style: CustomTextStyles.f14W400()),
                ],
              ),
              const SizedBox(height: 16),
              Row(
