...
Widget buildRubbishRemovalWidget(
    ...
    required int numberOfFurniture,
    required int numberOfMattress,
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text("Number of Tyres:", style: CustomTextStyles.f14W700()),
                  Text("${numberOfTyres}", style: CustomTextStyles.f14W400()),
                ],
              ),
              const SizedBox(height: 16),
              Row(
