              ...
              children: [
                ...
                Padding(
                  ...
                  child: CustomTextField(
                      ...
                      validator: Validators.checkFieldEmpty,
                      hint: "Total area of carpet steam cleaning",
                      textInputAction: TextInputAction.done,
                ...
                Padding(
                  ...
                  child: Theme(
                    ...
                    child: Obx(() => DropdownButtonFormField<String>(
                          ...
                          items: c.carpetCleaningUnitOption
                ...
                Padding(
                  padding:
                      const EdgeInsets.only(left: 18, right: 18, bottom: 10),
                  child: Text("Carpet stain cleaning area",
                      style: CustomTextStyles.f14W700()),
                ),
                Padding(
                  padding:
                  ...
                  child: CustomTextField(
                      controller: c.carpetStainCleaningArea,
                      //validator: Validators.checkFieldEmpty,
                      hint: "Total area of carpet stain cleaning",
                      textInputAction: TextInputAction.done,
                      textInputType: TextInputType.number),
                ),
                Padding(
                  padding:
                      const EdgeInsets.only(left: 18, right: 18, bottom: 10),
                  child: Text("Carpet Stain Cleaning Unit",
                      style: CustomTextStyles.f14W700()),
                ),
                Padding(
                  padding:
                  ...
                  child: Theme(
                    data: Theme.of(context)
                        .copyWith(canvasColor: AppColors.extraWhite),
                    child: Obx(() => DropdownButtonFormField<String>(
                          value: c.carpetStainCleaningUnit.value.isEmpty
                              ? null
                              : c.carpetStainCleaningUnit.value,
                          hint: Text(
                            "Select unit",
                            style: CustomTextStyles.f14W400(
                                color: AppColors.secondaryTextColor),
                          ...
                          items: c.carpetCleaningUnitOption
                              ...
                              .toList(),
                          onChanged: (value) {
                            c.updatecarpetStainCleaningUnit(value!);
                          },
                        )),
                  ),
                ),
