...
class HomeScreen extends StatelessWidget {
  ...
  // Shimmer effect for the whole page
...
class TestimonialWidget extends StatelessWidget {
  const TestimonialWidget({
    ...
    required this.name,
    required this.text,
    required this.rating, // New parameter for rating
  });
  final String image;
  final String name;
  final String text;
  final double rating; // New parameter for rating
          ...
          Row(children: [
            ...
            Column(
              ...
              children: [
                ...
                //StarWidget(rating: rating), // Pass the rating here
              ],
            ),
          ]),
